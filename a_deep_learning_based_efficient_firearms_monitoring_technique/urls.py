"""a_deep_learning_based_efficient_firearms_monitoring_technique URL Configuration
...
from a_deep_learning_based_efficient_firearms_monitoring_technique import settings
...
urlpatterns = [
    ...
    url(r'^Prediction__Of_Firearms_Monitoring_Type/$', remoteuser.Prediction__Of_Firearms_Monitoring_Type, name="Prediction__Of_Firearms_Monitoring_Type"),
    ...
    url(r'^Find_Predicted_Firearms_Monitoring_Type_Ratio/$', serviceprovider.Find_Predicted_Firearms_Monitoring_Type_Ratio, name="Find_Predicted_Firearms_Monitoring_Type_Ratio"),
    url(r'^Train_Test_DataSets/$', serviceprovider.Train_Test_DataSets, name="Train_Test_DataSets"),
    url(r'^View_Prediction__Of_Firearms_Monitoring_Type/$', serviceprovider.View_Prediction__Of_Firearms_Monitoring_Type, name="View_Prediction__Of_Firearms_Monitoring_Type"),
